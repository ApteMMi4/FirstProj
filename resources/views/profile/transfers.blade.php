...
@section('content')
    ...
    <div class="page-content">
            <div class="transfers__form">
                <div class="hero__pay-input-outer pay-input-outer transfers-input-outer">
                    ...
                    <div class="select arbitrary-payment__select">
                        ...
                        <div class="select__content">
                            ...
                            <div class="select__input">
                                <input type="radio" name="select-radio">
                                <span class="select__item">USD (0)</span>
                            </div>
                            <div class="select__input">
                                <input type="radio" name="select-radio">
                                <span class="select__item">BTC (0.000)</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <label class="hero__pay-input-outer pay-input-outer">
                    <span class="hero__pay-input-sup pay-input-sup">Коментарий</span>
                    <textarea class="pay-input pay-textarea"></textarea>
                </label>
                ...
                <button class="pc-profile__btn gradi-btn btn-hover2">Перевести</button>
            </div>
