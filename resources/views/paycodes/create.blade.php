        ...
        <section class="currencies user-page-v2">
            <div class="currencies__wrapper">
                ...
                <section class="pay-code api" style="background:#ffffff; box-sizing: border-box; padding: 1rem; max-width: 400px">
                  ...
                  <form action="{{route('paycode::store')}}" method="POST" id="data-form" enctype="multipart/form-data" class="pc-profile__form">
                  @csrf
                    ...
                    <div class="pc-profile__group">
                      <p>Сумма кода</p>
                      <input type="number" required name="paycode_amount" class="payment__input pc-profile__input" placeholder="" step="any" value="">
                    </div>

                    <div class="pc-profile__group">
                      <p>Код - выдаётся клиенту</p>
                      <input type="text" name="paycode_id" disabled class="payment__input pc-profile__input" placeholder="" value="{{$paycode_number}}">
                    </div>

                    <div class="pc-profile__group">
                      <p>Статус</p>
                      <select class="payment__input pc-profile__input" name="status">
                        <option value="0">Не погашен</option>
                        <option value="1">Погашен</option>
                        <option value="2">Заблокирован</option>
                        <option value="3">Удалён</option>
                      </select>
                    </div>

                    <div class="pc-profile__group">
                      <button type="submit" class="pc-profile__btn gradi-btn btn-hover2">Создать</button>
                    </div>
